...
/// <summary>
/// Authors the open map's landscape: its settings (from an export profile), and the map's channels and
/// layers. Materials are global and edited separately in <see cref="LandscapeMaterialsWindow"/>.
///
