...
public sealed class DotnetTraceWindow : Window
{
    ...
    private int _processId = Environment.ProcessId;
    private int _bufferSizeMb = 256;
    private string _providers = "";
    private string _outputDirectory = Path.Combine(Environment.CurrentDirectory, ".traces");
    ...
    public DotnetTraceWindow(WindowManager manager)
        : base("dotnet-trace", startOpen: false, defaultSize: new NVector2(620.0f, 430.0f))
    {
